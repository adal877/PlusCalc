...
/*float Analise_comb() {
  ...
  printf("1 - Fatorial\n");
  printf("2 - Arranjos de tipo A = N!/(N - P)\n");
  scanf("%d", &escolha);
}*/
...
char Cripto_Cesar() {
  ...
  printf("Entre com a mensagem para criptografar: \n");
  ...
  for(i = 0; mensagem[i] != '\0'; ++i){
	...
	printf("Mensagem encriptada: %s", mensagem);
...
char Decrip_Cesar() {
  ...
  printf("Entre com a mensagem criptografada: \n");
...
int ConvDec_to_Bin() {
  ...
  printf("Insira o numero decimal para conversao em binario (somente valores valores positivos): \n");
  scanf("%d", &bin);
...
int ConvBin_to_Dec() {
  ...
  printf("Insira o numero binario para conversao em decimal (somente valores positivos): \n");
  scanf("%d", &dec);
