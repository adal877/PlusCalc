...
void Somatorio();
void Matriz_Determi(int a[50][50], int b[50][50], int linhas, int colunas); 
...
void ConvDec_to_Bin() {
  ...
  Cores();
  printf("\n\033[0;32;1mInsira o numero \033[0;31;1mdecimal\033[m \033[0;32;1mpara conversao em binario (somente valores positivos e inteiros): \033[m\n");
  scanf(" %d", &bin);
