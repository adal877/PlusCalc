/*
******************ATENÇÃO*****************
    SÓ MECHE NO CODIGO SE SOUBER O QUE ESTA FAZENDO, 
...
//um banner para deixar a calculadora com um aspecto mais agradavel 
    printf("\033[0;36;1m@@@@@@@   @@@       @@@  @@@   @@@@@@    @@@@@@@   @@@@@@   @@@        @@@@@@@  \n@@@@@@@@  @@@       @@@  @@@  @@@@@@@   @@@@@@@@  @@@@@@@@  @@@       @@@@@@@@  \n@@!  @@@  @@!       @@!  @@@  !@@       !@@       @@!  @@@  @@!       !@@       \n!@!  @!@  !@!       !@!  @!@  !@!       !@!       !@!  @!@  !@!       !@!       \n@!@@!@!   @!!       @!@  !@!  !!@@!!    !@!       @!@!@!@!  @!!       !@!       \n!!@!!!    !!!       !@!  !!!   !!@!!!   !!!       !!!@!!!!  !!!       !!!       \n!!:       !!:       !!:  !!!       !:!  :!!       !!:  !!!  !!:       :!!       \n:!:        :!:      :!:  !:!      !:!   :!:       :!:  !:!   :!:      :!:       \n ::        :: ::::  ::::: ::  :::: ::    ::: :::  ::   :::   :: ::::   ::: :::  \n :        : :: : :   : :  :   :: : :     :: :: :   :   : :  : :: : :   :: :: :\n\033[m");
...
int ConvDec_to_Bin() {
  ...
  printf("\n");
  printf("\033[0;32;1mInsira o numero \033[0;31;1mdecimal\033[m \033[0;32;1mpara conversao em binario (somente valores valores positivos): \n\033[m");
  scanf("%d", &bin);
...
int ConvBin_to_Dec() {
  ...
  printf("\n");
  printf("\033[0;32;1mInsira o numero \033[0;31;1mbinario\033[m \033[0;32;1mpara conversao em decimal (somente valores positivos): \n\033[m");
  scanf("%d", &dec);
